...
### ۶) داده‌های اولیه (اختیاری)
برای ساخت دسته‌بندی‌ها و چند خبر نمونه‌ی دستی:
```bash
python manage.py seed_demo
```
سپس از پنل ادمین می‌توانید منبع RSS اضافه کنید و با اکشن «دریافت فیدهای
انتخاب‌شده هم‌اکنون» اخبار را وارد کنید.
